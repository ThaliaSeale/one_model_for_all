...
class Hemis_Net:
    ...
    def __init__(self, device):
        ...
        print("Segmenting Res Unit: in 64, out 16")
        ...
        print("Segmenting Res Unit: in 16, out 16")
    ...
    def combined_model(self,batch_data):
        ...
        if number_of_modalities != 1:
            ...
            (mins,_) = torch.min(outputs_tensor,dim=0)
        ...
        final_input = torch.cat((means,vars,maxes,mins),dim=1).to(self.device)
        # del means
        # del vars
