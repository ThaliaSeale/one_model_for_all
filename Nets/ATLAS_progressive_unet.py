...
pretrained_model_path = "/home/sedm6251/projectMaterial/baseline_models/Combined_Training/from_cluster/UNET_BRATS_MSSEG_TBI_WMH_BEST_BRATS.pth"
print("LOADING PRETRAINED MODEL:", pretrained_model_path)

manual_channel_map = [3] # not sure if I did this correctly
...
class ATLAS_progressive_UNET(theory_UNET_progressive):
